...
var gameState = function(game){
  ...
  //keep track of how many lives we have
  this.shipLives = shipProperties.startingLives;
  //display our lives counter
  this.tf_lives;
};
...
gameState.prototype = {
    ...
    update: function () {
      ...
      //if the bullet and asteroid overlap, call asteroidCollision
      game.physics.arcade.overlap(this.bulletGroup, this.asteroidGroup, this.asteroidCollision, null, this);
      //if ship and asteroid overlap, call asteroidCollision
